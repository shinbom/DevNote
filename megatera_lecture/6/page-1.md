...
![](./src/4-tier-layered-architecture.png)
...
![Service와 Domain Model을 서로 다른 계층으로 분리](./src/layered-architecture-1.png)
![Domain Model을 별개의 것으로 분리](./src/layered-architecture-2.png)
